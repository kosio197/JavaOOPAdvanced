package bg.softuni.customlist.command_interpreter;

import bg.softuni.customlist.model.contracts.CustomList;
import bg.softuni.customlist.model.contracts.Interpreter;
import bg.softuni.customlist.model.impl.CustomListImpl;
import bg.softuni.customlist.sortrer.Sorter;
...
public class CommandInterpreter implements Interpreter {
    ...
    public CommandInterpreter() {
        this.list = new CustomListImpl<String>();
    }
