package bg.softuni.genericbox.impl;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import bg.softuni.genericbox.contract.GenericBox;

public class GenericBoximpl<T> implements GenericBox<T> {

    private List<T> collection;

    public GenericBoximpl() {
